...
<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header">Add Missing Person</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
<div class="row">
	<div class="col-lg-8 col-lg-offset-2">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
            	<!-- <div class="row"> -->
                <form class="form" action="<?php echo $this->base_url.'admin/add_missing'; ?>" id="add-missing-form" method="post" enctype="multipart/form-data">
